          ...
          <div class="feature-grids row mb-lg-5 my-3">
            <div class="col-md-4 p-0">
              <div class="bottom-gd p-lg-5 p-4">
                ...
                <p>Questions related  Computer Science Engineering.</p>
              </div>
            </div>
            <div class="col-md-4 p-0">
              <div class="bottom-gd2-active p-lg-5 p-4">
                ...
                <p>Commerce students are  likely  be curious about entrepreneur.</p>
              </div>
            </div>
            <div class="col-md-4 p-0">
              <div class="bottom-gd p-lg-5 p-4">
      ...
      <div class="container py-xl-5 py-lg-3">
        <div class="row banner-grids">
          ...
          <div class="col-md-6 last-img pl-lg-5 p-3">
            ...
            <p class="mb-4"> University has been established under the  University Act,  The University is located in Bengaluru on a sprawling green campus, spread over 45 acres of land, built with state-of-the-art
