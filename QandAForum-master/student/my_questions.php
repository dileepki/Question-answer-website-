...
<body>
  <div class="">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">My Questions</li>
    </ol>
    <!---->

    <section class="ab-info-main py-md-5 py-4">
        <div class="container py-md-5 py-4">
            <h3 class="tittle text-center mb-lg-5 mb-3"><span class="sub-tittle">MY</span> Questions</h3>
                  <?php
                  $student_srn=$_SESSION['user_srn_session'];
                  // Include pagination library file
                  include_once '../includes/Pagination.class.php';


                  // Set some useful configuration
                  $baseURL = 'my_questions.php';
                  $limit = 5;

                  // Paging limit & offset
                  $offset = !empty($_GET['page'])?(($_GET['page']-1)*$limit):0;

                  $sql   ="SELECT COUNT(*) AS rowNum FROM questions WHERE srn='$student_srn'";
                  ...
                  $pagination =  new Pagination($pagConfig);
                            ...
                            $select_question_query="SELECT * FROM questions WHERE srn='$student_srn' ORDER BY question_id DESC LIMIT $offset,$limit";
                    ...
                    <h4 class="my-3"><?php echo '<a class="text-dark" href="student_question_thread.php?q_id='.$question_id.'">'.$question_content; ?>  </a></h4>
                    ...
                    <ul class="team-icons new-inf mt-md-4 mt-3 d-flex">
                        ...
                        <li><a href="#"><span class="fa fa-comment-o mx-1"></span> 1 </a></li>
