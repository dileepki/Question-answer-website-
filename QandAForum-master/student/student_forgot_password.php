  ...
  <div class="">
                    ...
                    <ul class="menu mt-2">
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li><a href="report_page.php">Teacher Reports</a></li>
                        </ul>
                      </li>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li><a href="remove_question_form.php">Remove Question</a></li>
    ...
    <section class="ab-info-main py-md-5 py-4">
        <div class="container py-md-5 py-4">
            <h3 class="tittle text-center mb-lg-5 mb-3"><span class="sub-tittle">Reset</span>Passworf here</h3>
          ...
          <div class="row footer-top mb-md-5 mb-4">
            <div class="col-lg-4 col-md-6 footer-grid_section_1its">
              ...
              <div class="footer-text">
                <p>Address : </p>
                <p>Phone : +91- </p>
                <p>Email : <a href=".edu.in">.edu.in</a></p>
              </div>
            </div>
...
<?php
    ...
    if (isset($_POST['get_password_button_s'])) {
      ...
      $hash_password=password_hash($new_p,PASSWORD_DEFAULT);
        ...
        $sql="UPDATE student_table SET password='$hash_password' WHERE security_question='$question' and security_answer='$answer'";
