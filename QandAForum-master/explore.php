        ...
        <div class="container py-md-5 py-4">
            <h3 class="tittle text-center mb-lg-5 mb-3"><span class="sub-tittle">Latest</span> Questions</h3>
                  ...
                  $pagination =  new Pagination($pagConfig);
                    ...
                    <h4 class="my-3"><?php echo '<a class="text-dark" href="question_thread.php?q_id='.$question_id.'">'.$question_content; ?>  </a></h4>
      ...
      <section class="footer footer_1its py-5">
        <div class="container py-md-4">
          <div class="row footer-top mb-md-5 mb-4">
            ...
            <div class="col-lg-4 col-md-12 mt-lg-0 mt-4 col-sm-12 footer-grid_section_1its" id="news">
              <div class="footer-title-w3ls">
                <h3>Newsletter</h3>
              </div>
              <div class="footer-text">
