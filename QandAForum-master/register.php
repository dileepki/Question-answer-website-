...
if (isset($_POST['register_button'])) {
    $s_usn=strtolower(mysqli_real_escape_string($conn, $_POST['student_usn']));
...
if (empty($s_urn) || empty($s_name) || empty($s_department) || empty($s_semester) || empty($s_section) || empty($s_email)
