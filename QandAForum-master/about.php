        ...
        <div class="feature-grids row mb-lg-5 my-3">
          <div class="col-md-4 p-0">
            <div class="bottom-gd p-lg-5 p-4">
              ...
              <p>Questions related  and Computer Science Engineering.</p>
            </div>
          </div>
          <div class="col-md-4 p-0">
      ...
      <div class="inner-sec-w3ls py-lg-5 py-4">
        ...
        <div class="row mt-lg-5 mt-4">
          <div class="col-md-4 team-gd text-center">
            ...
            <div class="team-info">
              <h3 class="mt-md-4 mt-3"><span class="sub-tittle-team">Android Developer</span> dileep</h3>
              <p>From  final Semester.</p>
    ...
    <div class="container py-xl-5 py-lg-3">
      <div class="row banner-grids">
        ...
        <div class="col-md-6 last-img pl-lg-5 p-3">
          ...
          <p class="mb-4">. The University is located in Bengaluru on a sprawling green campus, spread over 45 acres of land, built with state-of-the-art
             infrastructure creating an environment conducive to higher learning and research.</p>
          <p class="mb-4"> University is alive with the confluence of different minds and energies. The exchange and intermingling of these vivacities characterizes life at REVA.</p>
          <div class="ban-buttons">
            <a href="https://.edu.in/" class="btn">Read More</a>
          </div>
        </div>
      </div>
    </div>
