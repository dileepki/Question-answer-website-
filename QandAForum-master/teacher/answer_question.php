      ...
      <div class="container">
        <div class="newsletter-info text-center p-md-5 p-3">
          <form method="post" class="d-flex">
            <select class="form-control" name="var_subject">
...
while ($row = mysqli_fetch_array($subject_result)) {
 ...
 ?>
            ...
            <button type="submit" name="var_subject_btn" class="btn submit">Submit</button>
          </form>
        </div>
      </div>
    </section>
    ...
    <section class="ab-info-main py-md-5 py-4">
        <div class="container py-md-5 py-4">
            <h3 class="tittle text-center mb-lg-5 mb-3"><span class="sub-tittle">Answer</span> Questions</h3>
                  <?php
                  ...
                  if(isset($_POST['var_subject_btn'])){
                    $sub=$_POST['var_subject'];

                            $select_question_query="SELECT * FROM questions WHERE subject_id='$sub' ORDER BY question_id DESC LIMIT $offset,$limit";
                    ...
                    <ul class="team-icons new-inf mt-md-4 mt-3 d-flex">
                        ...
                        <li><?php echo '<a href="report.php?srn='.$question_by."&q_id=".$question_id.'">'?><span class="fa fa-remove-o mx-1"></span></a></li>
          ...
          <?php
                        ...
                        echo $pagination->createLinks(); ?>  </div>
