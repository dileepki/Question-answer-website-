            ...
            <div class="login p-md-5 p-4 mx-auto bg-white mw-100">
                ...
                <form method="post">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="srn_reset" placeholder="Enter SRN" required>
                  </div>
  ...
  <div class="login p-md-5 p-4 mx-auto bg-white mw-100">
      <form method="post">
        <div class="form-group">
          ...
          <input class="form-control" type="text" name="teacher_id_reset" placeholder="Enter Id" required>
        </div>
...
<?php
if (isset($_POST['reset_student_password_button'])) {
...
if (isset($_POST['reset_teacher_password_button'])) {
