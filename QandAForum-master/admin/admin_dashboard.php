          ...
          <div class="feature-grids row mb-lg-5 my-3">
            <div class="col-md-4 p-0">
              <div class="bottom-gd p-lg-5 p-4">
                ...
                <p>Questions related to  and Computer Science Engineering.</p>
              </div>
            </div>
            <div class="col-md-4 p-0">
        ...
        <div class="inner-sec-w3ls py-lg-5 py-4">
          ...
          <div class="row mt-lg-5 mt-4">
            <div class="col-md-4 team-gd text-center">
              ...
              <div class="team-info">
                <h3 class="mt-md-4 mt-3"><span class="sub-tittle-team">Android Developer</span> dileep v </h3>
                <p>engineering final year</p>
            ...
            <div class="col-md-4 team-gd second text-center">
              ...
              <div class="team-info">
                <h3 class="mt-md-4 mt-3"><span class="sub-tittle-team">Designer</span> pavithra</h3>
                <p>engineering </p>
                <ul class="social_section_1info mt-md-4 mt-3">
                </ul>
              </div>
            ...
            <div class="col-md-4 team-gd text-center">
              ...
              <div class="team-info">
                <h3 class="mt-md-4 mt-3"><span class="sub-tittle-team">PHP developer</span> Mohamad</h3>
                <p>Engineering</p>
                <ul class="social_section_1info mt-md-4 mt-3">
                </ul>
              </div>
    ...
    <section class="hand-crafted py-lg-4 py-5">
      <div class="container py-xl-5 py-lg-3">
        <div class="row banner-grids">
          ...
          <div class="col-md-6 last-img pl-lg-5 p-3">
            <h3 class="tittle text-white my-lg-5 my-3"><span class="sub-tittle">welcome to </span> University</h3>
            <p class="mb-4">. the engineeing institute of technology established in years and year of 2000 the main of the university goal 
              educate students based on the current industry standards and well educated 
               </p>
            <p class="mb-4"> University is alive with the confluence of different minds and energies. The exchange and intermingling of these vivacities characterizes life at </p>
            <div class="ban-buttons">
            ...
            <div class="col-lg-4 col-md-6 mt-md-0 mt-4 footer-grid_section_1its">
              ...
              <div class="row">
                ...
                <ul class="col-6 links">
                  ...
                  <li><a href="https://university.edu.in/faq">Faq's </a></li>
                </ul>
              </div>
            </div>
